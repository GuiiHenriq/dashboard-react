        ...
        <div className="pt-3">
          ...
          <div className="space-y-2">
            {realApiEmails.map((user, index) => (
              <div 
                key={index}
                className={`bg-white border rounded-lg p-3 hover:border-green-300 transition-colors cursor-pointer relative ${
                  copiedEmail === user.email ? 'border-green-400 bg-green-50' : 'border-green-200'
                }`}
